...
namespace denemeMVC.Controllers
{
    public class BlogController : Controller
    {
        ...
        {
            var blogs = db.Blogs.Include(b => b.Category).OrderByDescending(i=>i.EklenmeTarihi);
        ...
        public ActionResult Create([Bind(Include = "Baslik,Aciklama,Icerik,Resim,CategoryId")] Blog blog)
        {
            ...
            ViewBag.CategoryId = new SelectList(db.Categories, "Id", "KategoriAdi", blog.CategoryId);
            return View(blog);
        }
